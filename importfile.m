function simulation = importfile(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   SIMULATION = IMPORTFILE(FILENAME) Reads data from text file FILENAME
%   for the default selection.
%
%   SIMULATION = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from
%   rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   simulation = importfile('Server-2.txt', 1, 10);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2018/05/03 15:37:22
